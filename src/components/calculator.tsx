...
export function Calculator() {
    ...
    useEffect(() => {
        ...
        const isValid = Object.values(formData).every(
            ...
            (value) => {typeof value === "string" ? value.trim() !== "0" : value !== "0"
                console.log(value)
            }
        );
        ...
        >
            ...
            <div>
                ...
                <input
                    ...
                    value={formData.power_consumption > 0 ? formData.power_consumption : "" }
                    onChange={handleChange}
                    required
                    min="0"
                    className="w-full px-3 py-2 border border-gray-400 rounded focus:outline-none focus:ring focus:ring-yellow-500"
            ...
            <div>
                ...
                <input
                    ...
                    value={formData.electricity_cost > 0 ? formData.electricity_cost : ""}
                    onChange={handleChange}
                    required
                    min="0"
                    className="w-full px-3 py-2 border border-gray-400 rounded focus:outline-none focus:ring focus:ring-yellow-500"
            ...
            <div>
                ...
                <input
                    ...
                    value={formData.initial_investment > 0 ? formData.initial_investment : ""}
                    onChange={handleChange}
                    required
                    min="0"
                    className="w-full px-3 py-2 border border-gray-400 rounded focus:outline-none focus:ring focus:ring-yellow-500"
